...
namespace EventGrid_Topic
{
    class Program
    {
        static string _endpoint = "https://eventgridtopics.centralus-1.eventgrid.azure.net/api/events";
        static string _key = "cSJMYEsA5Qt5qjSliatesIlTG2mOZnrNN99Iw169gtw=";
