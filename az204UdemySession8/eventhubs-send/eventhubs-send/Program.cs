...
namespace eventhubs_send
{
    class Program
    {
        private static string connstring = "Endpoint=sb://az204eventhubnamespace.servicebus.windows.net/;SharedAccessKeyName=policyname;SharedAccessKey=K0pqggt4Zj+ML99UHWaGajYD44ju8bdC4WmAiT4DIVc=;EntityPath=az204eventhub";
        private static string hubname = "az204eventhub";
